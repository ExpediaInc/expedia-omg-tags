...
else if (utag.isRailUDP() && b['entity.railSearch.railDetail.railLegs.0.railOfferItems.0.fareClass']) {
   b['cabinClass'] = b['entity.railSearch.railDetail.railLegs.0.railOfferItems.0.fareClass'];
}
